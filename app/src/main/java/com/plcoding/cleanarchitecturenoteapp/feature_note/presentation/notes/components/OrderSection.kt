...
@Composable
fun OrderSection(modifier: Modifier, noteOrder: NoteOrder = NoteOrder.Date(OrderType.Descending),
...
@Composable
fun DisplayOrderSection() {
    OrderSection(modifier = Modifier, onOrderChange = {})
}